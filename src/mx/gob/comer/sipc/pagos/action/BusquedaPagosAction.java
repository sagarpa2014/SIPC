...
public class BusquedaPagosAction extends ActionSupport implements SessionAware, Serializable {
	...
	public String realizarConOficiosEnvioTesofe(){
		try{
			...
			lstOficioPagos = pDAO.consultaOficiosPago(idOficio,oficioCGC, (folioCLC!=null?folioCLC:0));
			bandera = true;
...
*/				
			...
			AppLogger.error("errores","Ocurrió un error al regresar el estatus del (los) pagos, debido a:"+e.getCause());
		}
		return SUCCESS;
	}
