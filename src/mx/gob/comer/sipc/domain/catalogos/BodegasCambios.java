...
public class BodegasCambios {
	...
	private Integer secuenciaBodega;
	
	@Id
	@GeneratedValue(generator = "bodegas_id_bodega_seq")
	@SequenceGenerator(name = "bodegas_id_bodega_seq", sequenceName = "bodegas_id_bodega_seq")
	...
	@Column(name = "secuencia_bodega")
	public Integer getSecuenciaBodega() {
		return secuenciaBodega;
	}
	public void setSecuenciaBodega(Integer secuenciaBodega) {
