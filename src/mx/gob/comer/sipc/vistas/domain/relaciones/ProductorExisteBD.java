...
@Entity
public class ProductorExisteBD implements Comparable  {
	@Id
	...
	public int compareTo(Object o) {
		ProductorExisteBD productor = (ProductorExisteBD) o;     
		if(this.paternoProductor.compareToIgnoreCase(productor.paternoProductor) == 0) {
        	if(this.maternoProductor.compareToIgnoreCase(productor.maternoProductor) == 0) {
        		  return this.nombreProductor.compareToIgnoreCase(productor.nombreProductor); 
        	}else{
        		return this.maternoProductor.compareTo(productor.maternoProductor);
        	}	                 
        } else { 
            return this.paternoProductor.compareToIgnoreCase(productor.paternoProductor); 
        }	    	             
	}
