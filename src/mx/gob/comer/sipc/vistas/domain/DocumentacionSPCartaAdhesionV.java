...
public class DocumentacionSPCartaAdhesionV{	
	...
	//Expediente Anexo 32-D con Archivo Historico
	public DocumentacionSPCartaAdhesionV(Integer idExpediente, String expediente, String folioCartaAdhesion, Date fechaExpedicionAnexo, Long idExpSPCartaAdhesion, String rutaDocumento, Boolean observacion, String rutaDocumentoHistorico) {
		super();
		this.idExpediente = idExpediente;
		this.expediente = expediente;
		this.folioCartaAdhesion = folioCartaAdhesion;
	...
	//Expediente Solicitud de apoyo (3) con Archivo Historico
	public DocumentacionSPCartaAdhesionV(Integer idExpediente, String expediente, String folioCartaAdhesion, Long idExpSPCartaAdhesion, String rutaDocumento,  Double volumen, Boolean observacion, String rutaDocumentoHistorico) {
		super();
		this.idExpediente = idExpediente;
		this.expediente = expediente;
		this.folioCartaAdhesion = folioCartaAdhesion;
	...
	//Expediente escrito libre(1) con Archivo Historico
	public DocumentacionSPCartaAdhesionV(Integer idExpediente, String expediente, String folioCartaAdhesion, Long idExpSPCartaAdhesion, Date fechaDocumento, Date fechaAcuse, String rutaDocumento, String rutaDocumentoHistorico) {
		super();
		this.idExpediente = idExpediente;
		this.expediente = expediente;
		this.folioCartaAdhesion = folioCartaAdhesion;
	...
	//Expediente Certificados de deposito con Archivo Historico
	public DocumentacionSPCartaAdhesionV(Integer idExpediente, String expediente, String folioCartaAdhesion, Long idExpSPCartaAdhesion, String rutaDocumento, int tipoConstancia, Boolean observacion, String rutaDocumentoHistorico) {
		super();
		this.idExpediente = idExpediente;
		this.expediente = expediente;
		this.folioCartaAdhesion = folioCartaAdhesion;
	...
	public DocumentacionSPCartaAdhesionV(Integer idExpediente, String expediente, String rutaDocumento, boolean requerido) {
		super();
		this.idExpediente = idExpediente;
		this.expediente = expediente;
		this.rutaDocumento = rutaDocumento;
	...
	@Column(name =  "ruta_documento_historico")
	public String getRutaDocumentoHistorico() {
		return rutaDocumentoHistorico;
	}
