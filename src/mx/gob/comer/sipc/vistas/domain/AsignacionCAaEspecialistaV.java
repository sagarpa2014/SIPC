...
public class AsignacionCAaEspecialistaV {
	...
	private Double volumenAutorizadoPago;
	private Double importeAutorizadoPago;
	...
	@Column(name = "volumen_autorizado_pago")
	public Double getVolumenAutorizadoPago() {
		return volumenAutorizadoPago;
	}
	public void setVolumenAutorizadoPago(Double volumenAutorizadoPago) {
		this.volumenAutorizadoPago = volumenAutorizadoPago;
	}	
	
	@Column(name = "importe_autorizado_pago")
	public Double getImporteAutorizadoPago() {
		return importeAutorizadoPago;
	}
	public void setImporteAutorizadoPago(Double importeAutorizadoPago) {
		this.importeAutorizadoPago = importeAutorizadoPago;
	}
