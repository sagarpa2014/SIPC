...
*PagosDetalleV
*
*Clase que mapea a la tabla "pagos_detalle_sb_v" de la base de datos sin considerar la clave de bodega  
*
*Versión 1.0
*
*Enero 2013
...
@Entity
@Table(name="pagos_detalle_sb_v")
public class PagosDetalleSBV {
	...
	public PagosDetalleSBV(){}


	
	public PagosDetalleSBV(int idEstado, Double volumen, Double importe,
