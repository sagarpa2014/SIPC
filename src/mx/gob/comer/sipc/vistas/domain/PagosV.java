...
public class PagosV {
	...
	@Column(name = "anexo32_vigente")
	public Integer getAnexo32Vigente() {
		return anexo32Vigente;
	}

	public void setAnexo32Vigente(Integer anexo32Vigente) {
		this.anexo32Vigente = anexo32Vigente;
	}
	...
	@Column(name = "fecha_pago_date")
	public Date getFechaPagoDate() {
		return fechaPagoDate;
	}

	public void setFechaPagoDate(Date fechaPagoDate) {
		this.fechaPagoDate = fechaPagoDate;
	}

	@Column(name = "no_oficio")
	public String getOficioPagos() {
		return oficioPagos;
	}

	public void setOficioPagos(String oficioPagos) {
