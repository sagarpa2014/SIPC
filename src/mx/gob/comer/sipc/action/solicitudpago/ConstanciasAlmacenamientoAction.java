...
public class ConstanciasAlmacenamientoAction extends ActionSupport implements SessionAware{
	...
	public String lstConstanciasAlmacenamiento(){
		try{
		...
		registrar = 2;
	    	...
	    	e.printStackTrace();
	    	AppLogger.error("errores","Ocurrio un error en lstConstanciasAlmacenamiento  debido a: "+e.getCause());
	    	addActionError("Ocurrio un error inesperado, favor de reportar al administrador");
	    } catch(Exception e) {
			e.printStackTrace();
			AppLogger.error("errores","Ocurrio un error en lstConstanciasAlmacenamiento  debido a: "+e.getMessage());
			addActionError("Ocurrio un error inesperado, favor de reportar al administrador");
		}
		return SUCCESS;	
	}
