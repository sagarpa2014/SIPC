...
public class InicializacionSolPagoAction extends ActionSupport implements SessionAware{
	...
	private Integer[] idExpedientesFianza1;
			...
			if(idExpedientesFianza!=null){
				...
				for(int i = 0; i < idExpedientesFianza.length; i++){
					//Guarda el expediente en la tabla de expediente_programa
					 ...
					 if(idExpedientesFianza1!=null){
						for(int j = 0; j < idExpedientesFianza1.length; j++){
							if (idExpedientesFianza1[j] == idExpedientesFianza[i]){
	...
	public Integer[] getIdExpedientesFianza1() {
		return idExpedientesFianza1;
	}
	public void setIdExpedientesFianza1(Integer[] idExpedientesFianza1) {
		this.idExpedientesFianza1 = idExpedientesFianza1;
	}
}
