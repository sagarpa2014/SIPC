...
public class PagosDAO {
	...
	public List<PagosV> consultaPagosV(long idPago, int idPrograma, int idComprador, String fechaInicio, String fechaFin) throws JDBCException {
		return consultaPagosV(idPago,idPrograma,idComprador,fechaInicio,fechaFin,null);
	}
	
	public List<PagosV> consultaPagosV(long idPago, int idPrograma, int idComprador, String fechaInicio, String fechaFin, String estatus) throws JDBCException {
		return consultaPagosV(idPago,idPrograma,idComprador,fechaInicio,fechaFin, estatus, 0,0, null);
	}

	public List<PagosV> consultaPagosV(long idPago, int idPrograma, int idComprador, String fechaInicio, String fechaFin, String estatus, String carta) throws JDBCException {
		return consultaPagosV(idPago,idPrograma,idComprador,fechaInicio,fechaFin, estatus, 0,0, carta);
	}

	public List<PagosV> consultaPagosV(long idOficio, String estatus) throws JDBCException {
			return consultaPagosV(0,0,0,"","",estatus, idOficio,0, null);
	}
	
	@SuppressWarnings("unchecked")
	public List<PagosV> consultaPagosV(long idPago, int idPrograma, int idComprador, String fechaInicio, String fechaFin, String estatus, long idOficio, long idEspecialista, String carta) throws JDBCException {
	...
	public List<PagosDetalleCAV> consultaPagosDetalleCAV(String folioCartaAdhesion, long idPago, Integer idEstado, Integer idCultivo, Integer idVariedad, Integer idEtapa) throws JDBCException {
		return consultaPagosDetalleCAV(folioCartaAdhesion,  idPago,  idEstado,  idCultivo,  idVariedad,  idEtapa, 0);
	}

	public List<PagosDetalleCAV> consultaPagosDetalleCAV(Integer idPagoDetalle){
		return consultaPagosDetalleCAV(null,  -1,  -1,  -1,  -1,  -1, idPagoDetalle);
	}
	
	@SuppressWarnings("unchecked")
	public List<PagosDetalleCAV> consultaPagosDetalleCAV(String folioCartaAdhesion, long idPago, Integer idEstado, Integer idCultivo, Integer idVariedad, Integer idEtapa, Integer idPagoDetalle) throws JDBCException {
		StringBuilder consulta= new StringBuilder();
		...
		if (idPagoDetalle!= 0 && idPagoDetalle!=-1){
			if(consulta.length()>0){
				consulta.append(" and idPagoDetalle=").append(idPagoDetalle);
			}else{
				consulta.append("where idPagoDetalle=").append(idPagoDetalle);
			}
		}
	...
	@SuppressWarnings("unchecked")
	public List<PagosDetalleGroupV> consultaPagosDetalleVByCultVariedadEdo(long idPago) throws JDBCException {
		StringBuilder consulta= new StringBuilder();
		List<PagosDetalleGroupV> lst=null;		
		consulta.append(" From PagosDetalleGroupV where idPago = "+idPago);
		lst= session.createQuery(consulta.toString()).list();	
		return lst;
	}
