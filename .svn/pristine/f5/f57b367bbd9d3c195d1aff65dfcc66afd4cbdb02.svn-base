...
public class CartaAdhesion {
	...
	private Boolean expedienteReabierto;
	private Date fechaDocFiniquito;
	private Date fechaAcuseFiniquito;
	private String rutaDocFiniquito;
	private Boolean expdienteFiniquitado;
	...
	@Column(name = "expediente_reabierto")
	public Boolean getExpedienteReabierto() {
		return expedienteReabierto;
	}
	public void setExpedienteReabierto(Boolean expedienteReabierto) {
		this.expedienteReabierto = expedienteReabierto;
	}
	
	@Column(name = "fecha_docto_finiquito")
	public Date getFechaDocFiniquito() {
		return fechaDocFiniquito;
	}
	public void setFechaDocFiniquito(Date fechaDocFin) {
		this.fechaDocFiniquito = fechaDocFin;
	}
	
	@Column(name = "fecha_acuse_finiquito")
	public Date getFechaAcuseFiniquito() {
		return fechaAcuseFiniquito;
	}
	public void setFechaAcuseFiniquito(Date fechaAcuseFiniquito) {
		this.fechaAcuseFiniquito = fechaAcuseFiniquito;
	}
	
	@Column(name = "ruta_docto_finiquito")
	public String getRutaDocFiniquito() {
		return rutaDocFiniquito;
	}
	public void setRutaDocFiniquito(String rutaDocFiniquito) {
		this.rutaDocFiniquito = rutaDocFiniquito;
	}
	
	@Column(name = "expdiente_finiquitado")
	public Boolean getExpdienteFiniquitado() {
		return expdienteFiniquitado;
	}
	public void setExpdienteFiniquitado(Boolean expdienteFiniquitado) {
		this.expdienteFiniquitado = expdienteFiniquitado;
	}
