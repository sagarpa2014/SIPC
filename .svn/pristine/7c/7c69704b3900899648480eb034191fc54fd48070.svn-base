...
public class Personal {
	...
	@Column(name = "ini_profesion")
	public String getIniProfesion() {
		return iniProfesion;
	}
	public void setIniProfesion(String iniProfesion) {
		this.iniProfesion = iniProfesion;
	}
