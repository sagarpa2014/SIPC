...
<s:if test="registrar==0 || registrar==1 || registrar == 3">	
	<div class="accion">
		<s:if test="docCartaAFileName =='' || docCartaAFileName==null">
			...
			<a href="<s:url value="/inscripcion/getDetalleSolIns?registrar=2&idSI=%{idSI}"/>" class="boton" title="" >Cancelar</a>
		</s:if>
	</div>
</s:if>
<div class="izquierda"><a href="<s:url value="/inscripcion/getDetalleSolIns?registrar=2&idSI=%{idSI}"/>" onclick="" title="" >&lt;&lt; Regresar</a></div>
