...
<s:form action="registroInicializaEsquema"  method="post" enctype="multipart/form-data" onsubmit="return chkCamposInicializa();">
	...
	<fieldset class="formulario" >
		...
		<div class="borderBottom" style="text-align:center"><h1>Titulo Aviso</h1></div><br> 
		<div>
			...
			<s:else>
				<s:textfield key="fechaPeticion" value="%{getText('fecha1',{fechaPeticion})}"  maxlength="10" size="10" id="fechaPeticion" readonly="true" cssClass="dateBox" />
			</s:else>
	...
	<s:if test="editar==0 || editar==1 || editar==3 || editar ==4">
		<div class="accion">
			...
			<a href="<s:url value="/inscripcion/listarProgramas?idPrograma=0"/>" class="boton" title="" >Cancelar</a>
		</div>
	</s:if>
	<s:elseif test="editar==2">
		<div class="accion">
			<a href="<s:url value="/inscripcion/listarProgramas?idPrograma=0"/>" class="boton" title="" >Regresar</a>
		</div>
	</s:elseif>
</s:form>
