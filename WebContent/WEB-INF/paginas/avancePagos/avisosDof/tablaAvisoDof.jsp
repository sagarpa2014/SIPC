...
<form>
	...
	<fieldset> 
		...
		<div>
			...
			<s:select id="idCultivo" cssClass="a" name="" list="lstCultivo" listKey="idCultivo" listValue="%{cultivo}" headerKey="-1" headerValue="-- Seleccione una opción --" tabindex="0" value="%{idCultivo}" />
		</div>
		<div class="clear"></div>	    
		<div>
