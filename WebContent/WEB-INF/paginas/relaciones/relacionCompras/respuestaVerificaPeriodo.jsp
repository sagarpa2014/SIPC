...
<s:if test="%{pidePeriodo==true}">
	...
	<s:if test="%{noSeTieneConfPerEnPrg==true}">
		<span class="requerido">No se ha configurado el periodo de acopio en la inicializaci&oacute;n del programa, favor de capturarlo</span><br>
	</s:if>
