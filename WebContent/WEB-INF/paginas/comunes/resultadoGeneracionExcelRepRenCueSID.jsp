...
<div class="withborder">
	...
	<s:else>
		<span class="error">
			No se pudo generar el reporte de rendicion de cuentas sin ID, por favor verifique!!!
		</span>	
		<br>
		<div class="accion">
...
<div class="clear"></div>
<div class="izquierda"><a href="<s:url value="/reportes/rendicionCuentasSID"/>" onclick="" title="" >&lt;&lt; Regresar</a></div>
