...
<div class="withborder">
	...
	<s:else>
		<span class="error">
			No se pudo generar el reporte detalle de seguimiento, por favor verifique!!!
		</span>	
		<br>
		<div class="accion">
...
<div class="clear"></div>
<div class="izquierda"><a href="<s:url value="/seguimiento/consultaReporteDetalle"/>" onclick="" title="" >&lt;&lt; Regresar</a></div>
