...
<s:form action="realizarConsultaRendicionCuentasSID" onsubmit="return chkCampoConsultaReporteRendicionCuentasSID();">
	<s:if test="hasActionErrors()">
	  	 <s:include value="/WEB-INF/paginas/template/abrirMensajeDialogo.jsp" />
	</s:if>
	<div class="borderBottom"><h1>REPORTE DE RENDICION DE CUENTAS</h1></div><br>
	...
	<s:if test="lstReporteRendicionCuentasSID.size() > 0">
		<br/>
		<div class="exporta_csv">
			<label class="label2"> Exportar Datos </label> <a href="<s:url value="/reportes/exportaReporteRendicionCuentasSID"/>" title="Exportar Datos" ></a>
		</div>
		<div class="clear"></div>
		<fieldset>
			<legend>Resultado de B&uacute;squeda</legend>
			<display:table id="l"  name="lstReporteRendicionCuentasSID" defaultsort="3" decorator="org.displaytag.decorator.TotalTableDecorator" list="lstReporteRendicionCuentasSID"  pagesize="30" sort="list" requestURI="/reportes/realizarConsultaRendicionCuentasSID"  class="displaytag">
				<display:column  property="nombreComprador" title="Persona F&iacute;sica"/>
				<display:column  property="razonSocial" title="Persona Moral"/>			
