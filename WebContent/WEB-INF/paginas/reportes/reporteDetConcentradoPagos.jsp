...
<s:if test="lstReporteDetConcentradoPagosV.size() > 0">
 	<s:if test="trimestre == 0">
		...
		<div class="clear"></div>
		<fieldset>
			<display:table id="r"  name="lstReporteDetConcentradoPagosV" defaultsort="2" decorator="org.displaytag.decorator.TotalTableDecorator" list="lstReporteDetConcentradoPagosV"  pagesize="20" sort="list" requestURI="/reportes/reporteDetalleConcentrado"  class="displaytag">
				...
				<display:column  property="nombreEdoPago" title="Origen del Grano"/>
