...
<legend>DATOS DEL REPRESENTANTE LEGAL</legend>
	...
	<div>
		...
		<font class="arial12bold"><s:property value="%{representanteLegalV.descNacionalidad}"/></font>
	</div>
	<div>
		<label class="left1">Estado Civil:</label>
		<font class="arial12bold"><s:property value="%{representanteLegalV.descEstadoCivil}"/></font>
	</div>
	<div>
		<label class="left1">Tipo Identificaci&oacute;n:</label>
		<font class="arial12bold"><s:property value="%{representanteLegalV.descTipoIdentificacion}"/></font>
	</div>
	<div>
		<label class="left1">Folio Identificaci&oacute;n:</label>
		<font class="arial12bold"><s:property value="%{representanteLegalV.folioIdentificacion}"/></font>
	</div>
	<div> 
		<label class="left1">RFE:</label>
		<font class="arial12bold"><s:property value="%{representanteLegalV.rfe}"/></font>
	</div>
	<div>
		<label class="left1">Documenta Acredita:</label>
		<font class="arial12bold"><s:property value="%{representanteLegalV.documentoAcredita}"/></font>
	</div>
	<div>
		<label class="left1">Vigencia del Poder:</label>
		<font class="arial12bold"><s:property value="%{getText('fecha1',{representanteLegalV.vigenciaPoder})}"/></font>
	</div>
	<div>
		<label class="left1">Tel&eacute;fono(s):</label>
		<font class="arial12bold"><s:property value="%{representanteLegalV.telefonos}"/></font>	
	</div>
	<div>
