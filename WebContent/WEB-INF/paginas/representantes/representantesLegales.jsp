		...
		<fieldset>
			...
			<display:table id="r"  name="lstRepresentanteLegal"  list="lstRepresentanteLegal"  pagesize="50" sort="list" requestURI="/catalogos/ejecutaBusquedaRepLegal"  class="displaytag">
				...
				<display:column title="Ver Detalle"  headerClass="sortable" >
					<a href='<s:url value="/catalogos/detallesRepresentante?idRepresentante=%{#attr.r.idRepresentante}&tipoPersona=%{#attr.r.tipoPersona}"/>' class="botonVerDetalles" title="" target="winload" onclick="window.open(this.href, this.target, 'width=600,height=750,scrollbars=yes'); return false;"></a>
			 	</display:column>
