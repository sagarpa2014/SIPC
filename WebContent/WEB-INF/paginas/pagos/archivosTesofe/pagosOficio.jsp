	...
	<div id="pagos">
		...
		<table style="width:100%">
			<tr>
				...
				<th>No. Carta</th>
				<th>Clabe</th>
				<th>Fecha Expedici&oacute;n Anexo 32-D</th>
				<th>Vigente</th>
				...
				<tr>
					...
					<td align="center">
						<s:if test="fechaExpedicionAnexo != null">
							<s:text name="fecha"><s:param value="%{fechaExpedicionAnexo}"/></s:text>
						</s:if>						
					</td>
					<td align="center">
						<s:if test="anexo32Vigente!=null">
							<s:if test="anexo32Vigente==1">
								SI
							</s:if>
							<s:else>
								NO
					...
					<td><a href='<s:url value="/pagos/detallesPago?idPago=%{idPago}"/>' class="botonVerDetalles" title="" target="winload" onclick="window.open(this.href, this.target, 'width=800,height=400,scrollbars=yes'); return false;"></a></td>
				</tr>	
			</s:iterator>	
		</table>	
		<div class="accion">
