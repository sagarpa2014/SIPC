...
<!-- 			<s:textfield  disabled="true" maxlength="100" size="30"  value="%{plaza.numeroPlaza}"/>  -->
	...
	<fieldset>
		...
		<s:if test="lstConsultaPagosCAEspecialista.size()>0">	
			<s:set name="idEstatusCAJ"><s:property value="idEstatusCA"/></s:set>	
			<table class="clean">
				<tr>
					<th class="clean">Fecha Solicitud Pago</th>
...
<%-- 						</s:if> --%>
				...
				<s:iterator value="lstConsultaPagosCAEspecialista" var="resultado" status="itStatus">
					<tr>
						<td>
							<s:textfield disabled="true" maxlength="15" size="15" value="%{getText('fecha',{#resultado.fechaAtentaNota})}" />
						</td>
						<td>
