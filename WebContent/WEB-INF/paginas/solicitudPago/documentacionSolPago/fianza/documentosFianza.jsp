...
<table  class="clean" style="width:100%">	
				...
				<td>
					<label class="">
						<s:if test="%{capturarInfoFianza == true}">
							...
							<s:else>
								<s:if test="%{requerido == true}">
									<span class="requerido">*</span><s:property value="%{expediente}"/>
								</s:if>
								<s:else>
									<span class="norequerido">*</span><s:property value="%{expediente}"/>
								</s:else>
							</s:else>									
						</s:if>
						<s:else>
				...
				<td>
					<s:if test="registrar==0">
						...
						<s:else>
							...
							<s:hidden id="docRequerido%{idExpediente}" name="docRequerido" value="%{requerido}"/>
						</s:else>
					</s:if>
	...
	<s:hidden id="idExpedientesRequeridos" name="idExpedientesRequeridos" value="%{idExpedientesRequeridos}"/>
</table>
