...
<table class ="clean">
	<tr>
		...
		<td>
		<td>
			<font class="arial12boldVerde"> (<a
				href='<s:url value="/inscripcion/getDetalleSolIns?registrar=2&idSI=%{idSI}"/>'
				title="">Solicitud de Inscripci&oacute;n</a>)
			</font>
		<td>
	</tr>
	<tr>
	...
	<s:if test="idCriterioPago==1 || idCriterioPago==3"> <!-- Volumen o Volumen/Etapa -->
		<tr>
			...
			<td>
			<td>
				<label class="left1"><span class="norequerido">*</span>Volumen Asignado en Carta:</label>
			</td>
			<td>
