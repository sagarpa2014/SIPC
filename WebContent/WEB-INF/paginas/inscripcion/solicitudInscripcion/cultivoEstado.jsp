...
<div class="clear"></div>
<s:hidden id="claveBodegaInvalida" name="claveBodegaInvalida" value="%{}"/>
<center>
			...
			<tr>
				...
				<s:iterator value="lstAsigCA" var="resultado"  status="itStatus">
					<tr>					
						...
						<td>
							<s:textfield id="claveBodega%{#itStatus.count}" name="capBodega" maxlength="15" size="15"  value="%{claveBodega}"  onkeyup="validaClaveBodegaSI(this.value, %{#itStatus.count});" onchange="validaClaveBodegaSI(this.value, %{#itStatus.count});"/>
						...
						<s:if test="idCriterioPago==1 || idCriterioPago==3">
							...
							<s:if test="volumenXCultivoVariedad==1"> <!-- Si en la inicializacion existe un limite de volumen por cultivo variedad -->
								<td>
									<s:textfield id="vxcv%{#itStatus.count}" name="" value=""  maxlength="14" size="20"  cssClass="cantidad" disabled="true"/>
								</td>
							</s:if>							
						</s:if>
