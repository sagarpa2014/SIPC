				...
				<display:table id="r"  name="lstSolInsV"  list="lstSolInsV"  pagesize="50" sort="list" requestURI="/inscripcion/ejecutaBusquedaSolicitudIns"  class="displaytag">
					...
					<display:column title="Ciclo">
			 		...
			 		<display:column title="Importe Asignado a Carta Adhesi&oacute;n" class="d">
			 			<s:if test="%{#attr.r.importeTotalCarta != 0}">
			 				<s:text name="importe"><s:param value="%{#attr.r.importeTotalCarta}"/></s:text>
			 			</s:if>			 			
			 		</display:column>
					...
					<display:footer>
				      <tr>
				        ...
				        <td class="d"><s:text name="volumen"><s:param value="%{totalVolSI}"/></s:text></td>
				        <td class="d"><s:text name="volumen"><s:param value="%{totalVolAutCA}"/></s:text></td>
				        <td class="">&nbsp;</td>
				        <td class="d"><s:text name="importe"><s:param value="%{totalImpAutCA}"/></s:text></td>
				        <td class="">&nbsp;</td>
				        <td class="">&nbsp;</td>
				      </tr>
			    </display:footer>
