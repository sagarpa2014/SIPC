...
<s:if test="datosCompradorCompleto==1">
	...
	<div>
		<label class="left1"><span class="norequerido">*</span>Representate Legal:</label>
	...
	<div class="clear"></div>		
	<s:include value="/WEB-INF/paginas/solicitudPago/documentacionSolPago/documentos/pagos.jsp"/>	
	...
	<s:elseif test="registrar==2">
		<div class="accion">
			<s:if test='#session.idPerfil!=6 && #session.idPerfil!=10'>
				<a href="<s:url value="/inscripcion/busquedaSolicitudIns"/>" class="boton" title="" >Regresar</a>
			</s:if>
			<s:else>
				<a href="<s:url value="/solicitudPago/selecAccionDocumentacion?folioCartaAdhesion=%{folioCartaAdhesion}"/>" class="boton" title="" >Regresar</a>
			</s:else>
		</div>
