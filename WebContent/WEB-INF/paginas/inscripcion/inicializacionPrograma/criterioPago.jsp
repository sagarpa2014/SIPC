...
<s:if test="idCriterioPago==1 || idCriterioPago ==3">
	...
	<div id="numVolPorCultivoVariedad">
		<div class="borderBottom" style="text-align:center"><h1>Volumen por Cultivo Variedad a Apoyar</h1></div><br>
		<div class="clear"></div>
		<s:if test="editar!=2">	
			<table class="clean">
				<tr>
					<td><span  id="agregarNumCamposVXCV" class="tipoBoton" onclick="agregarNumCamposVXCV();">Agregar Registro</span></td>
					<td><span id="removerNumCamposVXCV" class="tipoBoton" onclick="removerNumCamposVXCV();">Remover Registro</span></td>
				</tr>
			</table>
		</s:if>
		<s:hidden id="numCamposVXCV" name="numCamposVXCV" value="%{numCamposVXCV}"/>		
	</div>
...
<div class="clear"></div>	
<div class="borderBottom" style="text-align:center"><h1>Estados a Apoyar</h1></div><br>
<!-- <div> -->
...
<s:if test="editar!=2">
	<table class="clean">
		<tr>
			<td><span id="agregarNumCamposCultivoEstadoIniProg" class="tipoBoton"
				onclick="agregarNumCamposCultivoEstadoIniProg();">Agregar Registro</span></td>
			<td><span id="removerNumCamposCultivoEstadoIniProg" class="tipoBoton"
				onclick="removerNumCamposCultivoEstadoIniProg();">Remover Registro</span></td>
		</tr>
	</table>
</s:if>
